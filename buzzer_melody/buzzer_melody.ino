...
int melody[] = {
  ...
  NOTE_G5, NOTE_REST, NOTE_REST,  NOTE_REST,  NOTE_G4, NOTE_REST, NOTE_REST, NOTE_REST,
  
  NOTE_C5, NOTE_REST, NOTE_REST, NOTE_G4, NOTE_REST, NOTE_REST, NOTE_E4, NOTE_REST,
  NOTE_REST, NOTE_A4, NOTE_B4, NOTE_REST, NOTE_AS4, NOTE_A4, NOTE_REST,
  
  NOTE_G4, NOTE_E5, NOTE_G5, NOTE_A5, NOTE_REST, NOTE_F5, NOTE_G5, NOTE_REST,
  NOTE_E5, NOTE_REST, NOTE_C5, NOTE_D5, NOTE_B4, NOTE_REST, NOTE_REST, NOTE_G4,
  
  NOTE_REST, NOTE_E5, NOTE_REST, NOTE_G5, NOTE_A5, NOTE_REST, NOTE_F5, NOTE_G5, 
  NOTE_REST, NOTE_E5, NOTE_REST, NOTE_C5, NOTE_D5, NOTE_B4, NOTE_REST, NOTE_REST
};
